        ...
        <>
            ...
            >
                <Box className="sub-modal">
                    ...
                    >
                        <div
                            style={{ display: shopEditBox ? "block" : "none" }}
                            className=" absolute w-full h-full bg-white  top-0 left-0 z-[3000] pb-[60px] pt-5 px-[20px] rounded-[6px] "
                        >
                            ...
                            <div className="flex items-start justify-start flex-col w-full gap-5 ">
                                <div className=" flex items-start w-full justify-start flex-col gap-2">
                                    <h6 className="mb-[0px] text-[17px] font-[500] capitalize  ">
                                        {" "}
                                        Name(en)
                                    </h6>
